-- =============================================================================
-- Founder System — Atomic RPC (run in Supabase SQL Editor after founder_codes_apply.sql)
--
-- public.redeem_and_activate_founder_code(p_code, p_user_id)
--   • Locks founder_codes row
--   • Rejects invalid / used / expired
--   • Sets used=true + used_by_user_id + used_at
--   • Merges founder trial fields into auth.users.raw_user_meta_data
-- All in one transaction — avoids used=true without founder access.
-- =============================================================================

-- Allow authenticated clients to read codes for validateFounderCode (read-only).
...
-- -----------------------------------------------------------------------------
-- RPC: redeem + activate (SECURITY DEFINER — updates auth.users)
-- -----------------------------------------------------------------------------
