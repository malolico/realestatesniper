...
test("10 command envelopes and error catalog", () => {
  ...
  assert.equal(FACTORY_ORCHESTRATION_ERROR_CODES.PAYLOAD_TOO_LARGE, "PAYLOAD_TOO_LARGE");
  assert.equal(FACTORY_ORCHESTRATION_HTTP_STATUS.PAYLOAD_TOO_LARGE, 413);
  assert.equal(FACTORY_ORCHESTRATION_MAX_BODY_BYTES, 65536);
});
